    ...
    <div class="card mt-2">
        <div class="card-body">
            <form action="{{ Route('admin.kandidat.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="visi" value="{{ $candidate->visi }}" id="floatingInput" placeholder="Visi">
                    <label for="floatingInput">Visi</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text-area" class="form-control" name="misi" value="{{ $candidate->misi }}" id="floatingInput" placeholder="Misi">
